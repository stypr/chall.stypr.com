...
class ChallengeController extends Controller
{
    ...
    public function AuthAction()
    {
        ...
        if (!substr_count($flag, $flag_prefix)) {
            $flag = $flag_prefix . $flag;
        }
        if (!substr_count($flag, $flag_suffix)) {
        ...
        if ($check_flag->challenge_flag === $flag && $flag != ''
            ...
            $user->set($me);
            if ($check_flag->challenge_solve_count == '0') {
